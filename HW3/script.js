...
const ACCESS_KEY = 'zQ8hXLWz8Yl3csPH3GmL9kQH_D5xYTVt68_Y5KQbdCE';
...
const loadLocalStorage = () => {
    const storageData = JSON.parse(localStorage.getItem('JPM'));
...
const like = (event) => {
    ...
    if (likeEl.getAttribute('fill') === 'white') {
        ...
        localStorage.setItem('JPM', JSON.stringify(Array.from(photoMap.values())));
    } else {
